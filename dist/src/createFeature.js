    ...
    return new Promise(function (resolve) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, common_1.readAndCompileTemplate("./templates/feature.hbs", data)];
                case 1:
                    template = _a.sent();
                    return [4 /*yield*/, common_1.saveToFile(data.path + "/" + data.name + ".ts", template)];
                case 2:
                    _a.sent();
                    resolve(true);
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _a.sent();
                    chalk_1.default.red.bold(e_1.toString());
                    resolve(false);
                    return [3 /*break*/, 4];
    ...
    return new Promise(function (resolve) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            inquirer
                ...
                .then(function (answers) {
                answers.path = pathToSave += cwd + "/" + answers.path.replace(/^\/|\/$/g, "");

        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    project.addSourceFileAtPath(__dirname + "../../../../src/templates/NewSlice.ts");
...
exports.default = (function (data, path) {
    return new Promise(function (resolve) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            pathToSave = path_1.getPath("Slices");
            if (path) {
                pathToSave = path_1.getPath(path);
            }
            console.log(chalk_1.default.white.bold("Crafting a new slice. Answer a few questions, please.\r\n"));
            inquirer_1.default
                .prompt([
                {
                    type: "question",
                ...
                createSlice(data).then(function (res) {
                    resolve(res);
                });
            });
            return [2 /*return*/];

...
exports.default = (function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, tsconfig_resolver_1.tsconfigResolver()];
            case 1:
                result = _a.sent();
                if (result.exists) {
                    packageJsonPath = path_1.default.dirname(result.path) + "/node_modules/@feature-framework/core/package.json";
                    try {
                        if (fs_1.default.existsSync(packageJsonPath)) {
                            pckg_1 = require(packageJsonPath);
                            if (pckg_1.version)
                                additionalInfo.push(chalk_1.default.white("Feature Framework: v." + pckg_1.version));
                        }
                    }
                    catch (e) { }
                }
